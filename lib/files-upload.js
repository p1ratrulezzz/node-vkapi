...
function upload (type, params = {}) {
  ...
  // Use at your own risk. This is just a "hack" giving the alibity to upload graffiti to vk.com. 
  // Only .png and .svg files were tested. 
  // 
  // To send uploaded graffiti just attach it to message as a document (doc<owner_id>_<doc_id>). 
