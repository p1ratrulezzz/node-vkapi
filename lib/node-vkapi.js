...
class VKApi {
  constructor (options) {
    ...
    this.antiCaptcha = AntiCaptcha(this.options.captcha.antiCaptchaKey);
  }
  ...
  _getDelay () {
    ...
    if ((dateNow - this.lastRequestTime) > 334) 
      ...
      return (334 - (dateNow - this.lastRequestTime));
  }
    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        return resolve(prequest(url, {
          ...
          // Captcha needed
          if (e.name === 'VKError' && e.vk_error.error_code === 14) {
            if (this.antiCaptcha !== null) {
              return this.antiCaptcha.recognize(e.vk_error.captcha_img).then(res => {
              ...
              return new Promise(r => setTimeout(() => r(this[selfArgs.shift()](...selfArgs)), this.captcha.delay));
            }
          }
