...
class VKApi {
  constructor (options) {
    ...
    this.antiCaptcha = AntiCaptcha(this.options.captcha.antiCaptchaKey, this.options.captcha.service);
  }
        ...
        return resolve(prequest(url, {
          ...
          if (e.name === 'VKError' && e.vk_error.error_code === 14) {
            if (this.antiCaptcha !== null) {
              ...
              return new Promise(r => setTimeout(() => r(this[selfArgs.shift()](...selfArgs)), this.options.captcha.delay));
            }
          }
